...
```
In the T-Test above we found a significant difference between the means of the skill and line players. The mean came up as 49.72 for the skill players, and 17.12 for the line players. 


$H_0$:  There is no relationship between position and pushups in the pushup data.

$H_a$: There IS a relationship between position and pushups in the pushup data.
...
Overall I concluded that skill players did more pushups than line players. While running this experiment I wondered why line players had a significant difference in data compared to that of skill players. After running a Side-by-Side Histogram, I was able to observe the difference in the skill players. The data was significantly different because there were more skilled players. The Side-by-Side Historgram also showed the difference in the amount of pushups, the result clearly showed the skill players completed more pushups.In the Two-way table I was able to compare the mean of both positions. The mean showed a clear difference , the skill players had a mean of 47.5, while the line players had a total mean of 17.12. It was clear that skill players completed more pushups. Skill players had a max of 108 pushups while line players had a max of 34. Our alternative hypothesis was that there was a relationship between position and pushups and our results are able to confirm that.